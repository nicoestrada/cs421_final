...
/* package basicWebServer-0.1.0.0 */
#ifndef VERSION_basicWebServer
#define VERSION_basicWebServer "0.1.0.0"
#endif /* VERSION_basicWebServer */
#ifndef MIN_VERSION_basicWebServer
#define MIN_VERSION_basicWebServer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_basicWebServer */
...
#define CURRENT_COMPONENT_ID "basicWebServer-0.1.0.0-5brH16B07uHL5ZrAFSTXme-basicWebServer"
